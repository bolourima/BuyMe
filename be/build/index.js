...
app.post("/createProduct", multer_1.default.array("images"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, productController_1.createProduct)(req, res);
}));
app.put("/editProduct", multer_1.default.array("images"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, productController_1.editProduct)(req, res);
}));
app.put("/editSub", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
